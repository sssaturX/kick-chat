  ...
  return (
    ...
    >
      <div className="grid lg:grid-cols-2 gap-10 lg:gap-16 items-center">
        <div>
          <h1 className="text-3xl sm:text-4xl lg:text-5xl font-bold text-saturx-dark tracking-tight">
            {t.hero.headline}
          </h1>
          ...
          <div className="mt-8 flex flex-wrap gap-4">
            <a
              href="#get-saturx"
              className="inline-flex px-6 py-3.5 rounded-lg bg-saturx-purple hover:bg-saturx-purple-light text-white font-medium transition-colors"
            >
              {t.hero.button}
            </a>
            <a
              href="#features"
              className="inline-flex px-6 py-3.5 rounded-lg border border-saturx-border text-saturx-dark hover:bg-saturx-bg-subtle font-medium transition-colors"
            >
              {t.hero.learnMore}
            </a>
          </div>
  ...
  return (
    <div className="relative w-full max-w-md aspect-square">
      <svg viewBox="0 0 400 400" className="w-full h-full" aria-hidden>
        ...
        {/* Abstract wireframe-style shapes */}
        ...
        <circle cx="200" cy="200" r="24" fill="url(#hero-grad1)" fillOpacity="0.2" stroke="url(#hero-grad2)" strokeWidth="1.5" />
