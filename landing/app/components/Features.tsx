...
function IconOne() {
  return (
    <svg className="w-10 h-10 text-saturx-purple" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <section id="features" className="py-16 sm:py-20 lg:py-24 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-saturx-dark text-center max-w-2xl mx-auto">
        ...
        <div className="mt-12 sm:mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-8 lg:gap-10">
          {blocks.map((block, i) => {
            ...
            return (
              <div
                key={i}
                className="rounded-2xl border border-saturx-border bg-white p-6 sm:p-8 hover:border-saturx-purple/20 hover:shadow-md transition-all"
              >
                <div className="flex items-center justify-center w-14 h-14 rounded-xl border-2 border-saturx-purple/30 bg-saturx-purple-soft/50 mb-5">
                  <Icon />
                </div>
                <h3 className="text-lg font-semibold text-saturx-dark mb-2">{block.title}</h3>
